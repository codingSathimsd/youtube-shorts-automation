...
def generate_seo(video_title, transcript_snippet, channel_name):
    """Use Gemini to generate viral SEO metadata"""
...
{{
    "title": "catchy title under 60 chars with hook word",
    "description": "2-3 sentence description with keywords, ends with call to action",
