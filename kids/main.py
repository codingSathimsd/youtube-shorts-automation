...
def morning_pipeline():
    ...
    try:
        ...
        print("\n[2/7] ✍️  Writing 30-scene professional script...")
        ...
        print("\n[4/7] 🎙️  Generating natural human voices...")
        voice_data = generate_all_voices(scenes, output_dir)

        print("\n[5/7] 🎬 Building 3D animated scenes...")
        ...
        final_path, duration_sec = assemble_final_video(
            scene_clips, script["episode_title"], output_dir, topic_plan)

        print("\n[7/7] 🏷️  SEO + Upload...")
        seo_data = generate_viral_seo(topic_plan, script, duration_sec/60)
        ...
        print(f"🎬 {seo_data['title']}")
        print(f"⏱️  {duration_sec/60:.1f} minutes")
        print("="*60)
